  ...
  <div class="row justify-content-center">
    <div class="container-fluid card" style="margin-top:-45;">
      <div class="card-header card-header-primary "style="background: linear-gradient(180deg, #64a3d6, #1c5196);">
        ...
        <p class="card-category">En esta seccion es posible ver cada uno de los movimientos del sistema. <br> Además con la opción ver detalle, puede conocer más información del mismo.</p>
      </div>
